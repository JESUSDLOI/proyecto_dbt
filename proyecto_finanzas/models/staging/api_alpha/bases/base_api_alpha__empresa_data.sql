WITH source AS (
  ...
  SELECT
    ...
    {{ dbt_utils.generate_surrogate_key([TRIM(simbolo)]) }} AS id_ticker, /* Clave única para identificar los datos de la empresa */
    ...
    CAST(TRIM(_DLT_ID) AS VARCHAR(255)) AS id_dlt /* Id del registro */
  FROM source
)
SELECT
  *
