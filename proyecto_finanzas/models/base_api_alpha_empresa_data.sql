...
renamed as (
   SELECT
    ...
    OVERVIEW__DESCRIPTION::VARCHAR(16777216) as descripcion,
    ...
    OVERVIEW__FISCAL_YEAR_END::VARCHAR(255) as fin_anyo_fiscal,                      --Mes escrito
    OVERVIEW__LATEST_QUARTER::DATE as ultimo_trimestre,
